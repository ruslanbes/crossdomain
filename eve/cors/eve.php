...
<p>I'm sitting on the domain <strong>eve</strong>.ruslanbes.com and Fred is on the domain <strong>fred</strong>.ruslanbes.com. I will do the same what Cindy did and get the message from <a href="http://fred.ruslanbes.com/cors/fred.php">http://fred.ruslanbes.com/cors/fred.php</a>, but Fred have set <span class="code">Access-Control-Allow-Origin</span> header for me</p>
