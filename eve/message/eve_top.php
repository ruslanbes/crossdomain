...
We use iframe for our communication too, and Fred is on <a href="http://fred.ruslanbes.com/message/fred_top.php">http://fred.ruslanbes.com/message/fred_top.php</a>. Hovewer we use top.postMessage() for communication.</p>
...
<div class="bottom">
  ...
  <iframe src="http://fred.ruslanbes.com/message/fred_top.php" id="freds_iframe"></iframe>
</div>
</body>
</html>
...
$("#get_freds_message").click(function() {
  ...
  top.postMessage("How about a lunch?", 'http://fred.ruslanbes.com')
})
</script>
